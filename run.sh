...
declare -a tasks=("fluorescence" "subloc" "solubility" "contact" "yeast" "aav" ) 
...
do
    ...
    do
        ...
        CUDA_VISIBLE_DEVICES=1,2,3,4,5,6,7 python -m torch.distributed.launch --nproc_per_node=7 --master-port=29500 script/run_single.py -c temp.yaml --seed 0 > "$log_file" 2>&1
